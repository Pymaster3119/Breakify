...
// to the server at https://breakify-s9eu.onrender.com/predict. The server returns decoded
  ...
  useEffect(() => {
    ...
    const sendFrame = async () => {
      ...
      try {
        ...
        const resp = await fetch('https://breakify-s9eu.onrender.com/predict?img_size=' + imgSize, {
          method: 'POST',
          body: form
        })
        if (!resp.ok) {
